...
<template>
    <div class="min-w-[1150px] h-full bg-gray-100">
        <div v-if="accountAndList" class="top-0 z-20 fixed w-full h-full bg-black bg-opacity-50"></div>
        <div class="flex items-center bg-gray-900 h-[60px] py-2 px-2 fixed z-50 min-w-[1150px] w-full">
            <div class="flex">
                <Link :href="route('dashboard')" class="text-white h-[50px] p-2 pt-3 border-[1px] border-gray-900 rounded-sm hover:border-[1px] hover:border-gray-100">
                ...
                <Link v-if="$page.props.auth.user" :href="route('address.index')">
                    <div class="flex items-center justify-center">
                        ...
                        <div>
                            ...
                            <div v-if="$page.props.auth.address" class="text-[14px] text-white -mt-1.5 font-extrabold">
            ...
            <div class="flex grow items-center h-[45px] px-1">
                <div class="flex items-center justify-center bg-gray-100 font-extrabold text-[11px] text-gray-600 w-[60px] h-[40px] border-r border-r-gray-300 rounded-l-md cursor-pointer">
                    <div class="pt-[3px]">
                        All
                    </div>
            ...
            <div class="flex">
                <div class="text-white h-[50px] p-2 border-[1px] border-gray-900 rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-center mt-2.5 px-1">
                        ...
                        <div class="text-[14px] font-extrabold -mr-0.5 -mt-2">EN</div>
                ...
                <div @mouseenter="accountAndListFunc(true)" @mouseleave="accountAndListFunc(false)" class="h-[50px] p-2 border-[1px] border-gray-900 rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                        ...
                        <div>
                            ...
                            <div>
                                <div class="flex items-center">
                                    <div class="text-[14px] text-white font-extrabold -mt-1.5">Account & List</div>
                    ...
                    <div v-if="accountAndList" class="bg-white absolute z-50 top-[56px] -ml-[230px] w-[480px] rounded-sm px-6">
                            ...
                            <div class="flex">
                                ...
                                <div class="w-1/2 ml-5">
                                    <div class="pb-3">
                                        ...
                                        <Link class="block text-sm hover:text-red-600 hover:underline pt-3" :href="route('profile.edit')">
                                            Account
                                        </Link>
                                        <Link class="block text-sm hover:text-red-600 hover:underline pt-3" :href="route('logout')" 
                        ...
                        <div v-else class="p-4 text-center">
                            ...
                            <Link :href="route('login')" class="text-center items-center px-20 py-1.5 bg-[#fcba1f] 
                                border border-gray-600 rounded-sm text-sm font-extrabold text-black">
                                Sign in
                            </Link>
                ...
                <div class="h-[50px] p-2 border-[1px] border-gray-900 rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-center">
                        <div>
                            ...
                            <div>
                                <div class="flex items-center">
                                    <div class="text-[14px] text-white font-extrabold -mt-1.5">& Orders</div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <Link :href="route('cart.index')" class="relative block h-[50px] p-2 border-[1px] border-gray-900 rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <span class="absolute text-center w-[14px] text-[14px] top-[1px] left-[18px]">
                        <div class="text-orange-400 font-extrabold bg-gray-900 h-[17px]">{{ cartStore.cart.length }}</div>
                    </span>
                    <div class="flex items-center justify-center">
                        <CartMinusIcon fillColor="#fcfcfc" :size="35" class="-mt-0.5"/>
                        <div class="text-white mt-3 -ml-1 font-extrabold text-[14px]">Cart</div>
                    </div>
                </Link>
            </div>
        </div>

        <div class="flex items-center justify-between bg-[#232f3e] px-2 h-[38px] fixed z-40 min-w-[1150px] w-full mt-[60px]">
            <div class="flex">
                ...
                <div class="flex h-[30px] border-[1px] border-[#232f3e] rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-between px-2">
                        <div class="text-[14px] text-white font-extrabold">Today's Deal</div>
                    </div>
                </div>
                <div class="flex h-[30px] border-[1px] border-[#232f3e] rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-between px-2">
                ...
                <div class="flex h-[30px] border-[1px] border-[#232f3e] rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-between px-2">
                        <div class="text-[14px] text-white font-extrabold">Shuvo's Amazon.com</div>
                    </div>
                </div>
            </div>
            <div class="flex">
        ...
        <div class="w-full bg-white mt-10 overflow-x-scroll">
            <div class="max-w-[1500px] mx-auto px-4">
                <div class="text-[23px] pt-4 px-4 font-extrabold">Recommended based on your shopping trends</div>
                <div class="flex items-stretch">
                    <div v-for="product in $page.props.random_products" :key="'pro'+product.id">
    ...
    <div v-show="showMenu" class="fixed top-0 z-50 w-full h-full bg-black bg-opacity-70">
        <CloseIcon
        ...
        />
        <transition leave-active-class="animate__animated animate__slideOutLeft animate__faster">
        <div v-show="showMenu" class="w-80 h-full bg-white" :class="[showMenu ? 'animate__animated animate__slideInLeft animate__faster' : '']">
            ...
            <div v-for="cat in $page.props.categories" :key="'side'+cat.id">
