...
const isAlreadyInCart = computed(()=>{
    return cart.value.some(el=>el.id === product.value.id);
})
</script>
...
<template>
    ...
    <AuthenticatedLayout>
        <div class="mt-16"></div>
        <div class="max-w-1200 mx-auto flex gap-4 justify-between">
            <div class="w-2/5">
            ...
            <div class="w-2/5">
                ...
                <div>
                    ...
                    <div class="text-xl font-extrabold m-1">{{ product.description }}</div>
                </div>
            </div>
            <div class="w-1/5">
                <div class="border border-gray-300 rounded-lg">
                    <div class="my-2 mx-3 mb-2">
                        ...
                        <div class="flex items-center justify-between pt-2">
                            ...
                            <button class="bg-yellow-400 px-2 font-bold text-sm rounded-lg border shadow-sm 
                            cursor-pointer" :disabled="isAlreadyInCart" @click.prevent="addToCart(product)">
